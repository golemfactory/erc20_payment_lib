...
async function main() {
  ...
  const routerFactory = await hre.ethers.getContractFactory("contracts/Router.sol:UniswapV2Router02");

  const routerContract = await routerFactory.deploy("0x5757371414417b8c6caad45baef941abc7d3ab32", "0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889");
